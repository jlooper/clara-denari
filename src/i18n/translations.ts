...
export const translations: Translations = {
  ...
  'lab.3.instructions': {
    en: 'The key is coated with a sticky layer of mascarpone cheese, the traditional cannoli filling. Use a Refiner to wipe off the cheese from the key.',
    fr: 'La clé est recouverte d\'une couche collante de mascarpone, le remplissage traditionnel des cannolis. Utilisez un Réflecteur pour retirer le fromage de la clé.',
    es: 'La llave está cubierta con una capa pegajosa de queso mascarpone, el relleno tradicional de los cannolis. Utiliza un Reflector para retirar el queso de la llave.',
    'pt-br': 'A chave está coberta com uma camada pegajosa de queijo mascarpone, o recheio tradicional dos cannolis. Use um Refletor para retirar o queijo da chave.'
  }
};
