...
export const translations: Translations = {
  ...
  // About page
  'about.content': {
    en: '<p>Cloudinary Experiments are apps that explore Cloudinary\'s image, video, and audio transformation capabilities.</p> <p>The images in this game were generated by ChatGPT. Each backdrop image uses the "fl_c2pa" transformation to help trace provenance using the C2PA standard. Learn more about C2PA <a href="https://c2pa.org" target="_blank" class="text-blue-400 hover:text-blue-300 underline">here</a>. Learn more about this transformation at <a href="https://cloudinary.com/documentation/image_transformations#c2pa_transformation" target="_blank" class="text-blue-400 hover:text-blue-300 underline">Cloudinary documentation</a>.</p>',
